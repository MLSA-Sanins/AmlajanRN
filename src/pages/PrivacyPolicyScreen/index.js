    ...
    <ScrollView>
      <View style={styles.Page}>
        ...
        <Text style={styles.paragraph}>
          ...
          about the individual web pages or products that you view, what Apps or
          search terms referred you to the App, and information about how you
        ...
        <Text style={styles.paragraph}>
          ...
          on the App, and collect data including your IP address, browser type,
          Internet service provider, referring/exit pages, and date/time stamps.
          - “Web beacons,” “tags,” and “pixels” are electronic files used to
          record information about how you browse the App.
        </Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.subHeader}>DO NOT TRACK</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          ...
          by e-mail at adrenine13@gmail.com or by mail using the details
          provided below:
        </Text>
